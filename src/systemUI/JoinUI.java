...
public class JoinUI extends JFrame {
    ...
    public JoinUI(Client client) {
        ...
        IDField.setFont(new Font("나눔스퀘어라운드 Regular", Font.PLAIN, 18));
        ...
        name_Field.setFont(new Font("나눔스퀘어라운드 Regular", Font.PLAIN, 18));
        ...
        id_chack_button.setFont(new Font("나눔스퀘어라운드 ExtraBold", Font.PLAIN, 17));
        id_chack_button.setBounds(242, 101, 100, 44);
        contentPane.add(id_chack_button);
        
        textField = new JTextField();
        textField.setFont(new Font("나눔스퀘어라운드 Regular", Font.PLAIN, 18));
        ...
        textField_1.setFont(new Font("나눔스퀘어라운드 Regular", Font.PLAIN, 18));
        ...
        textField_2.setFont(new Font("나눔스퀘어라운드 Regular", Font.PLAIN, 18));
        ...
        textField_3.setFont(new Font("나눔스퀘어라운드 Regular", Font.PLAIN, 18));
        ...
        textField_4.setFont(new Font("나눔스퀘어라운드 Regular", Font.PLAIN, 18));
