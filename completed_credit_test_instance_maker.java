...
//초기화 -> 학점인정 신청(선택적) -> 저장 순서
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		do_initial(2015123456, 2018, 1, "미국", "하버드", "컴퓨터", "이산수학", 2, 4.0, false);
		do_initial(2015123456, 2018, 1, "미국", "하버드", "컴퓨터", "기초물리학실험", 3, 3.3, false);
		do_initial(2015123456, 2018, 1, "미국", "하버드", "컴퓨터", "기초공학설계", 3, 2.7, false);
		do_initial(2015123456, 2018, 1, "미국", "하버드", "컴퓨터", "기초프로그래밍", 3, 3.0, false);

		do_initial(2015123456, 2018, 2, "미국", "하버드", "컴퓨터", "공학수학", 2, 3.7, false);
		do_initial(2015123456, 2018, 2, "미국", "하버드", "컴퓨터", "자료구조", 3, 3.7, false);
		do_initial(2015123456, 2018, 2, "미국", "하버드", "컴퓨터", "자료구조응용", 3, 4.0, false);
		do_initial(2015123456, 2018, 2, "미국", "하버드", "컴퓨터", "자바프로그래밍", 3, 3.3, false);
		do_initial(2015123456, 2018, 2, "미국", "하버드", "컴퓨터", "오토마타", 2, 2.3, false);
		do_initial(2015123456, 2018, 2, "미국", "하버드", "컴퓨터", "논리회로", 2, 3.0, false);

		do_initial(2015123456, 2019, 1, "영국", "옥스포드", "전자", "기초전자수학", 2, 4.0, false);
		do_initial(2015123456, 2019, 1, "영국", "옥스포드", "전자", "기초전자물리학", 2, 4.3, false);
		do_initial(2015123456, 2019, 1, "영국", "옥스포드", "전자", "기초전자실험설계", 3, 4.0, false);
		do_initial(2015123456, 2019, 1, "영국", "옥스포드", "전자", "전자회로설계", 3, 4.0, false);
		do_initial(2015123456, 2019, 1, "영국", "옥스포드", "전자", "논리회로설계", 3, 3.7, false);
